...
This is a list of publications using STATCONT:
 ...
 - *Radio outburst from a massive (proto)star. When accretion turns into ejection*
   by: Cesaroni et al. 2018, A&A, 612, A103 ([link](https://ui.adsabs.harvard.edu/abs/2018A%26A...612A.103C/abstract))

 - *Distributed Star Formation throughout the Galactic Center Cloud Sgr B2*
   by: Ginsburg et al. 2018, ApJ, 853, 171 ([link](https://ui.adsabs.harvard.edu/abs/2018ApJ...853..171G/abstract))

 - *The physical and chemical structure of Sagittarius B2 - II. Continuum millimeter emission of SgrB2(M) and SgrB2(N) with ALMA*
   by: Sanchez-Monge et al. 2017, A&A, 604, A6 ([link](https://ui.adsabs.harvard.edu/abs/2017A%26A...604A...6S/abstract))

 - *Chasing disks around O-type (proto)stars: Evidence from ALMA observations*
   by: Cesaroni et al. 2017, A&A, 602, A59 ([link](https://ui.adsabs.harvard.edu/abs/2017A%26A...602A..59C/abstract))
